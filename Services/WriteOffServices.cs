...
namespace sky.recovery.Services
{
    public class WriteOffServices : SkyCoreConfig, IWriteOffServices
    {
        ...
        public WriteOffServices(IGeneralParam GeneralParam, IWebHostEnvironment environment, IUserService User, IHelperRepository helperRepository, IRestruktureRepository postgreRepository,
