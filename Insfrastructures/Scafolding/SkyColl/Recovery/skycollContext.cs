...
namespace sky.recovery.Insfrastructures.Scafolding.SkyColl.Recovery
{
    public partial class skycollContext : DbContext
    {
        ...
        public virtual DbSet<Auctionapproval> Auctionapprovals { get; set; }
        public virtual DbSet<Auctiondocument> Auctiondocuments { get; set; }
        public virtual DbSet<Aydum> Ayda { get; set; }
        public virtual DbSet<Generalparamdetail> Generalparamdetails { get; set; }
        public virtual DbSet<Generalparamheader> Generalparamheaders { get; set; }
        public virtual DbSet<Insurance> Insurances { get; set; }
        public virtual DbSet<Insuranceapproval> Insuranceapprovals { get; set; }
        public virtual DbSet<Insurancedocument> Insurancedocuments { get; set; }
        public virtual DbSet<Masterdocrule> Masterdocrules { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Aydum>(entity =>
            {
            ...
            modelBuilder.Entity<Restrukturedokuman>(entity =>
            {
