...
{
    public partial class SkyCollPublicDBContext : DbContext
    {
        public SkyCollPublicDBContext()
        {
        }

        public SkyCollPublicDBContext(DbContextOptions<SkyCollPublicDBContext> options)
            : base(options)
        {
        }

        public virtual DbSet<AccountDistribution> AccountDistribution { get; set; }
        public virtual DbSet<AccountDistributionReq> AccountDistributionReq { get; set; }
        public virtual DbSet<Action> Action { get; set; }
        public virtual DbSet<ActionGroup> ActionGroup { get; set; }
        public virtual DbSet<ActionGroupReq> ActionGroupReq { get; set; }
        public virtual DbSet<ActionReq> ActionReq { get; set; }
        public virtual DbSet<Area> Area { get; set; }
        public virtual DbSet<AreaReq> AreaReq { get; set; }
        public virtual DbSet<Branch> Branch { get; set; }
        public virtual DbSet<Bucket> Bucket { get; set; }
        public virtual DbSet<BucketDetail> BucketDetail { get; set; }
        ...
        public virtual DbSet<ContentNotifikasi> ContentNotifikasi { get; set; }
        public virtual DbSet<ContentNotifikasiDetail> ContentNotifikasiDetail { get; set; }
        public virtual DbSet<Counter> Counter { get; set; }
        public virtual DbSet<DocSignature> DocSignature { get; set; }
        public virtual DbSet<FcMappingMikroCollection> FcMappingMikroCollection { get; set; }
        public virtual DbSet<FcMappingMikroCollectionReq> FcMappingMikroCollectionReq { get; set; }
        public virtual DbSet<GenerateLetter> GenerateLetter { get; set; }
        public virtual DbSet<GenericParam> GenericParam { get; set; }
        ...
        public virtual DbSet<MasterNotaris> MasterNotaris { get; set; }
        public virtual DbSet<NotifContent> NotifContent { get; set; }
        public virtual DbSet<PaymentHistory> PaymentHistory { get; set; }
        public virtual DbSet<PaymentHistoryBk20240513> PaymentHistoryBk20240513 { get; set; }
        public virtual DbSet<PaymentRecord> PaymentRecord { get; set; }
        public virtual DbSet<Reason> Reason { get; set; }
        public virtual DbSet<Rfproduct> Rfproduct { get; set; }
        public virtual DbSet<RfproductSegment> RfproductSegment { get; set; }
        public virtual DbSet<Rfresult> Rfresult { get; set; }
        public virtual DbSet<Status> Status { get; set; }
        public virtual DbSet<StgMasterLoan> StgMasterLoan { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MasterNotaris>(entity =>
            {
